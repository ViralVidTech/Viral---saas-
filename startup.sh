...
sleep 2
pip install fastapi uvicorn python-multipart httpx peft decord librosa einops timm imageio imageio-ffmpeg easydict dashscope diffusers ftfy opencv-python-headless -q
